...
const fetchCategories = async () => {
    const categoyResponse = await fetch("https://jsonserver-vercel-api.vercel.app/categories");
    return await categoyResponse.json();
};
const fetchPrices = async () => {
    const pricesResponse = await fetch("https://jsonserver-vercel-api.vercel.app/prices");
    return await pricesResponse.json();
};
const fetchColors = async () => {
    const colorsResponse = await fetch("https://jsonserver-vercel-api.vercel.app/colors");
    return await colorsResponse.json();
};
const fetchCompanies = async () => {
    const companiesResponse = await fetch("https://jsonserver-vercel-api.vercel.app/companies");
    return await companiesResponse.json();
};
const fetchProducts = async () => {
    const productsResponse = await fetch("https://jsonserver-vercel-api.vercel.app/products");
